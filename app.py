...
# setting function and instance again
...
async def on_chat_start():
    ...
    while files is None:
        files = await cl.AskFileMessage(
            ...
            accept=["application/pdf", "text/plain"],  # Adjust this line
            max_size_mb=20,
            timeout=180,
        ).send()
    file = files[0]
